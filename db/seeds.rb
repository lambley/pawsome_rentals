...
photo_array = [
  'https://res.cloudinary.com/le-wagon-london-campus-batch-904/image/upload/v1660399641/download_m6vfgc.jpg',
...
36.times do
  ...
  c.photo.attach(io: URI.open(photo_array.sample), filename: 'image.jpg')
end
